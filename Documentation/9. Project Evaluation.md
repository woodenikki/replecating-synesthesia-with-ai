...
| 3. | Minimum of 12 hours of research (Neural nets, similar AI projects, python application with AI, etc.) | Completed. Time spent on Research(ML/DL) was [time]. Time spent on Research(Synesthesia) was [time]. Refer to [**Time Report**](). |
...
Especially given how little data I used to train the model, I'm extremely happy with these results. 
    ...
    I completed 50% of my tertiary goals (2/4).
