...
| - | --------- | ---------- |
| 1. | Reflect on the goal of finding the expected outcome for each category with 50% accuracy. | Color, Texture, and Luminosity models successfully met the primary 50% accuracy goal. Refer to the [**Accuracy Reflection** page](6.%20Accuracy%20Reflection.md). |
...
## How Would You Have Done Things Differently if You Had the Opportunity?
